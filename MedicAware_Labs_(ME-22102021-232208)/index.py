...
def register_mach():
    ...
    if request.method=="POST":
        ...
        data = requests.get("https://api.medicaware.intellx.co.in/read?key=$OSC&file=eqpt").json()

        eqpt = {
                    "code": request.form.get("code"),
                    "durn": request.form.get("durn"),
        ...
        requests.post("https://api.medicaware.intellx.co.in/write?key=$OSC&file=eqpt",data={"content":json.dumps(data,indent=4)})
